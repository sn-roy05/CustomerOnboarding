...
import { OMNIDEF } from './integrationProcedureCustomerOnboardingEnglish_def.js';
import tmpl from './integrationProcedureCustomerOnboardingEnglish.html';
import tmpl_nds from './integrationProcedureCustomerOnboardingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class integrationProcedureCustomerOnboardingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
